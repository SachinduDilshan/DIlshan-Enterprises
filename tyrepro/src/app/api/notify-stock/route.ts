...
async function runCheck() {
  ...
  // Load active product IDs to filter deleted products
  ...
  // Load all stock records — skip any linked to deleted/inactive products
  ...
  // Always overwrite stock alert types — removes stale entries for deleted products
  ...
  // merge: false = full document overwrite so nothing can linger
